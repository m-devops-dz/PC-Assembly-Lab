...
const chokeMat=new T.MeshStandardMaterial({color:0x5a5d63,metalness:.5,roughness:.5});
[-8,-6.6,-5.2,-3.8,-2.4].forEach(z=>mesh(box(.85,.65,.85),chokeMat,[-7.4,.425,z]));
const capTop=new T.MeshStandardMaterial({color:0xb8bcc2,metalness:.85,roughness:.3}), capBody=new T.MeshStandardMaterial({color:0x2a2b2f,metalness:.4,roughness:.4});
...
mesh(box(9.1,1.14,.85),new T.MeshStandardMaterial({color:0xc9ced4,metalness:.9,roughness:.3}),[-9.85,.64,3.2]);   // steel armor on PCI_E1
